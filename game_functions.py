...
def check_keydown_events(event, ai_settings, screen, stats, play_button, ship, aliens, bullets):
    ...
    if event.key == pygame.K_RIGHT:
        ...
        _start_game(ai_settings, screen, stats, play_button, ship, aliens, bullets)
    elif event.key == pygame.K_q:
        sys.exit()
    

def fire_bullet(ai_settings, screen, ship, bullets):
    """ Fire a bullet if limit is not reeached """
...
def _start_game(ai_settings, screen, stats, play_button, ship, aliens, bullets):
